function [Gmin_adjMatrix,scores,evals] = DAGsearch2(X,maxIter,restartVal,complexityFactor,PP)
% Inputs:
%   X(instance,feature)
...
Gloss = solveGloss(parents,X,i);
familyScore = score(Gloss,sum(adjMatrix(:,i)),complexityFactor);
end
