...
% [X,G,nodeNames] =spdGeneration4(data,nSamples,1);
% save('./ChainData/GenData1000/SpdChain1000Data.mat','X');
% save('./ChainData/GenData1000/SpdChain1000Graph.mat','G');
...
f1 = load('./ChainData/GenData100/TransSpdChain100_3col.mat');
X = f1.CS;
f2 = load('./ChainData/GenData1000/SpdChain1000Graph.mat');
G = f2.G;
...
pvalMatrix = load('./ChainData/GenData100/pvalMatrix100_3col.mat');
